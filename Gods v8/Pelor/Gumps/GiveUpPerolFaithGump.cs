...
{
	public class GiveUpPerolFaithGump : Gump
	{
		...
		public GiveUpPerolFaithGump( BookofPerol stone, int listPage, ArrayList list, ArrayList count ) : base( 50, 50 )
		{
			m_Stone = stone;
         		m_List = list;
         		m_ListPage = listPage;   
			...
			AddLabel(42, 30, 1149, @"Give up your belief in God Perol?");
