...
{
	public class FaithPointsVecnaStoreGump : Gump
	{

		public FaithPointsVecnaStoreGump()
			: base( 0, 0 )
		{
			this.Closable=true;
			...
			this.AddLabel(280, 240, 567, @"Proof of Faith - promotion to Necromancer");
			...
			AddItem(210, 317, 0x4B9D); //Necromancer Robe
			this.AddLabel(280, 310, 567, @"Necromancer Robe");
			...
			AddItem(210, 400, 0x2253); //Necromancer Spellbook
			this.AddLabel(280, 380, 567, @"NecromancerSpellbook");
			...
			if ( from == null )
				...
				{
					Item mp = new MarkOfPriestGodVecna();
				...
				{
					Item pp = new ProofofFaithGodVecna();
				...
				{
					Item csb = new NecromancerSpellbook();
				...
				{
					Item modfv = new MedallionofDevotedFollowerVecna();
					from.AddToBackpack(modfv);
