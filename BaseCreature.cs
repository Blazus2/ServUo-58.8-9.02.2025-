...
////FS:ATS Edits
		#region FS:ATS Edits
		private int m_A1RoarAttack;
		private int m_A1PetPoisonAttack;
		private int m_A1FireBreathAttack;

		private bool m_A3IsMating;

		private int m_A2ABPoints;
		private int m_A2Exp;
		private int m_A2NextLevel;
		private int m_A2Level = 1;
		private int m_A2MaxLevel;

		private bool m_A3AllowMating;

		private bool m_A3Evolves;
		private int m_A3Gen = 1;

		private DateTime m_A3MatingDelay;
		...
		private string m_A3Hodowca;
		[CommandProperty(AccessLevel.GameMaster)]
		public virtual string A3Hodowca
		{
			get { return m_A3Hodowca; }
			set { m_A3Hodowca = value; InvalidateProperties(); }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public int A1RoarAttack
		{
			get{ return m_A1RoarAttack; }
			set{ m_A1RoarAttack = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public int A1PetPoisonAttack
		{
			get{ return m_A1PetPoisonAttack; }
			set{ m_A1PetPoisonAttack = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public int A1FireBreathAttack
		{
			get{ return m_A1FireBreathAttack; }
			set{ m_A1FireBreathAttack = value; }
		}

		[CommandProperty( AccessLevel.Administrator )]
		public DateTime A3MatingDelay
		{
			get{ return m_A3MatingDelay; }
			set{ m_A3MatingDelay = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public int A3Generation
		{
			get{ return m_A3Gen; }
			set{ m_A3Gen = value; }
		}
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public int A2AbilityPoints
		{
			get{ return m_A2ABPoints; }
			set{ m_A2ABPoints = value; }
		}
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public int A2NextLevel
		{
			get{ return m_A2NextLevel; }
			set{ m_A2NextLevel = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public int A2Level
		{
			get{ return m_A2Level; }
			set{ m_A2Level = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public int A2MaxLevel
		{
			get{ return m_A2MaxLevel; }
			set{ m_A2MaxLevel = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool A3Evolves
		{
			get{ return m_A3Evolves; }
			set{ m_A3Evolves = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool A3AllowMating
		{
			get{ return m_A3AllowMating; }
			set{ m_A3AllowMating = value; }
		}
...
////FS:ATS Edits
        ...
        public virtual void InitializeAbilities()
        {
            ...
            {
                if (Skills[SkillName.Wampiryzm].Value == 0)
                    SetSkill(SkillName.Wampiryzm, 2, 20);

                if (Skills[SkillName.WykrywanieUkrytych].Value == 0 && !(this is BaseVendor))
                    SetSkill(SkillName.WykrywanieUkrytych, Utility.RandomList(10, 60));
            }
        }
        ...
        {
            if (_Mastery == SkillName.Alchemia)
            {
                Masteries = null;
            }
            else
...
*/
        ...
        public virtual double GetControlChance(Mobile m, bool useBaseSkill)
        {
            ...
            int taming = (int)((useBaseSkill ? m.Skills[SkillName.Oswajanie].Base : m.Skills[SkillName.Oswajanie].Value) * 10);
            int lore =   (int)((useBaseSkill ? m.Skills[SkillName.WiedzaOZwierzetach].Base : m.Skills[SkillName.WiedzaOZwierzetach].Value) * 10);
...
////FS:ATS Edits
			...
			m_A2MaxLevel = Utility.RandomMinMax( 1, 11 );
			#endregion
////FS:ATS Edits
...
////Version 26 FS:ATS EDITS
			writer.Write(m_A3Hodowca);
			writer.Write( (bool) m_A3IsMating );
			writer.Write( (int) m_A2ABPoints );
			writer.Write( (int) m_A2Exp );
			writer.Write( (int) m_A2NextLevel );
			writer.Write( (int) m_A2Level );
			writer.Write( (int) m_A2MaxLevel );
			writer.Write( (bool) m_A3AllowMating );
			writer.Write( (bool) m_A3Evolves );
			writer.Write( (int) m_A3Gen );
			writer.Write( (DateTime) m_A3MatingDelay );
			...
			writer.Write( (int) m_A1RoarAttack );
			writer.Write( (int) m_A1PetPoisonAttack );
			writer.Write( (int) m_A1FireBreathAttack );
////FS:ATS EDITS
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            {
////FS:ATS EDITS
		m_A3Hodowca = reader.ReadString();
		m_A3IsMating = reader.ReadBool();
		m_A2ABPoints = reader.ReadInt();
		m_A2Exp = reader.ReadInt();
		m_A2NextLevel = reader.ReadInt();
		m_A2Level = reader.ReadInt();
		m_A2MaxLevel = reader.ReadInt();
		m_A3AllowMating = reader.ReadBool();
		m_A3Evolves = reader.ReadBool();
		m_A3Gen = reader.ReadInt();
		m_A3MatingDelay = reader.ReadDateTime();
		...
		m_A1RoarAttack = reader.ReadInt();
		m_A1PetPoisonAttack = reader.ReadInt();
		m_A1FireBreathAttack = reader.ReadInt();
////FS:ATS EDITS
            }
        ...
        public virtual bool OnGoldGiven(Mobile from, Gold dropped)
        {
            ...
            else if (IsHumanInTown())
            {
                ...
                SpeechHue = 0x23F;
                SayTo(from, "Dajesz mi z³oto?");

                if (dropped.Amount >= 400)
                {
                    SayTo(from, "To szlachetny prezent.");
                }
                else
                {
                    SayTo(from, "Pieni¹dze s¹ zawsze mile widziane.");
                }
                ...
                if (CheckFoodPreference(f))
                {
                    ...
                    if (amount > 0)
                    {
                        ...
                        if (IsBondable && !IsBonded)
                        {
                            ...
                            {
                                if (m_CurrentTameSkill <= 29.1 || master.Skills[SkillName.Oswajanie].Base >= m_CurrentTameSkill ||
                                    OverrideBondingReqs() || (Core.ML && master.Skills[SkillName.Oswajanie].Value >= m_CurrentTameSkill))
                                {
        ...
        public void ChangeAIType(AIType NewAI)
        {
            ...
            switch (NewAI)
            {
                ...
                case AIType.AI_Necro:
                    ...
                    break;
////AI STRA¯Y
                case AIType.AI_MeleeGuardAI:
                    m_AI = new MeleeGuardAI(this);
                    break;
                case AIType.AI_ArcherGuardAI:
...
#region Flying_AI
        ...
        public virtual Poison GetHitPoison()
        {
            ...
            int level = 1;
            double total = Skills[SkillName.Zatruwanie].Value;
        ...
        private bool TryHitPoison()
        {
            ...
            return Skills[SkillName.Zatruwanie].Value >= Utility.Random(300);
        }
        ...
        */
        ...
        private class TameEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                if (Owner.From.UseSkill(SkillName.Oswajanie) && Owner.From.Target != null)
                {
        ...
        public virtual bool CheckTeach(SkillName skill, Mobile from)
        {
            ...
            if (skill == SkillName.Skradanie && from.Skills[SkillName.Ukrywanie].Base < Stealth.HidingRequirement)
            {
                return false;
            }

            if (!Core.EJ && skill == SkillName.UsuwaniePulapek &&
                (from.Skills[SkillName.Otwieranie].Base < 50.0 || from.Skills[SkillName.WykrywanieUkrytych].Base < 50.0))
            {
                return false;
            }

            if (!Core.AOS && (skill == SkillName.Wampiryzm || skill == SkillName.Rycerstwo || skill == SkillName.Nekromancja))
            {
                return false;
            }
...
////FS:ATS
        ...
        public void SetSkill(SkillName name, double val)
        {
            ...
            if (name == SkillName.Zatruwanie && Skills[name].Base > 0 && 
                !Controlled &&
...
#region FS:ATS Edits////
			if ( this.Tamable == true && FSATS.EnablePetBreeding == true )
			{
				...
				{
					if ( this.Female == true )
						list.Add( 1060658, "P³eæ\tSamica" );
					else
						list.Add( 1060658, "P³eæ\tSamiec" );

					//if ( this.Controlled == false )
					//	list.Add( 1060659, "Mo¿liwy Postêp Hodowlany\t{0}", this.A2MaxLevel );
				}

////
			if ( this.Controlled == true && this.m_A3Gen > 1 )
			{
				if ( A3Hodowca == null )
					list.Add("<BASEFONT COLOR=#FF8300>(wyhodowany)<BASEFONT COLOR=#FFFFFF>");
				else if ( A3Hodowca != null )
					list.Add("<BASEFONT COLOR=#FF8300>(Wyhodowany Przez {0})<BASEFONT COLOR=#FFFFFF>", A3Hodowca);	
			}
////
            ...
            {
                list.Add(1157315, EngravedText); // <BASEFONT COLOR=#668cff>Oznaczony: ~1_VAL~<BASEFONT COLOR=#FFFFFF>
            }
			...
			if ( FSATS.EnablePetLeveling == true )
			{
				...
				foreach ( Mobile mob in list )
				{
					if ( mob is BaseCreature )
					{
						...
						PetLeveling.CheckLevel( this, bc, list.Count );
					}
				}
			}
#endregion////
...
////
        ...
        */
        ...
        public virtual void Heal(Mobile patient)
        {
            ...
            else
            {
                ...
                if (chance > Utility.RandomDouble())
                {
                    ...
                    CheckSkill(SkillName.Leczenie, 0.0, Skills[SkillName.Leczenie].Cap);
                    CheckSkill(SkillName.Anatomia, 0.0, Skills[SkillName.Anatomia].Cap);
                }
                else if (PetTrainingHelper.Enabled && Controlled)
                {
                    CheckSkill(SkillName.Leczenie, 0.0, 10);
        ...
        public virtual bool DoDiscord()
        {
            ...
            if (target == null || !target.InLOS(this) || !InRange(target.Location, BaseInstrument.GetBardRange(this, SkillName.Oslabianie)) || CheckInstrument() == null)
                return false;
            ...
            if (!UseSkill(SkillName.Oslabianie))
                return false;
        ...
        public virtual bool DoPeace()
        {
            ...
            if (target == null || !target.InLOS(this) || !InRange(target.Location, BaseInstrument.GetBardRange(this, SkillName.Uspokajanie)) || CheckInstrument() == null)
                return false;

            if (Spell != null)
                Spell = null;

            if (!UseSkill(SkillName.Uspokajanie))
                return false;
        ...
        public virtual bool DoProvoke()
        {
            ...
            if (target == null || !target.InLOS(this) || !InRange(target.Location, BaseInstrument.GetBardRange(this, SkillName.Prowokacja)) || CheckInstrument() == null || !(target is BaseCreature))
                return false;

            if (Spell != null)
                Spell = null;

            if (!UseSkill(SkillName.Prowokacja))
                return false;
        ...
        public virtual Mobile GetSecondTarget(BaseCreature first)
        {
            ...
            int range = BaseInstrument.GetBardRange(this, SkillName.Prowokacja);
        ...
        public virtual void TryFindPlayer()
        {
            ...
            double srcSkill = Skills[SkillName.WykrywanieUkrytych].Value;
