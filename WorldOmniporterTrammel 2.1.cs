 ...
 *	  
 * Updated February 25, 2019: This is a custom version released
 *		for Arcadius on ServUO. Improved some readability of gump
 * 		text. Improved code design to more easily allow custom
 *		destination entries.
 *	  
...
#####																		
##### -- Drop anywhere in Scripts folder.												
##### -- Run command "[WorldOmniGen" in the game. This will delete any WorldTeleporters and ( if any )		
#####    existing WorldOmniporters, and place new WorldOmniporters.								
