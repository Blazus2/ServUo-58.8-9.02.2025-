...
{
    public class Wampiryzm
    {
        public static void Initialize()
        {
            SkillInfo.Table[(int)SkillName.Wampiryzm].Callback = new SkillUseCallback(OnUse);
        }
        ...
        public static TimeSpan OnUse(Mobile m)
        {
			...
			{  
				pm.SendMessage ( "Choose the target you want to bite." );
				pm.Target = new InternalTarget();
			} 
			else
			{  
				pm.SendMessage ( "You can't do that." );
