//M³odaCzarownica by PAN POMIDOR
using System;
using Server;
using Server.Misc;
using Server.Items;
...
{
	[CorpseName( "human corpse" )]
	public class WitchApprentice : BaseCreature
	{
		[Constructable]
		public WitchApprentice() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
            this.Name = NameList.RandomName("female");
            this.Title = "Witch Apprentice";
            this.Body = 401;
            ...
            this.SetSkill(SkillName.OcenaIntelektu, 125.1, 150.0);
            this.SetSkill(SkillName.Magia, 125.1, 150.0);
            this.SetSkill(SkillName.OdpornoscNaMagie, 175.0, 197.5);
            this.SetSkill(SkillName.Taktyka, 65.0, 87.5);
            this.SetSkill(SkillName.WalkaPiesciami, 90.2, 160.0);
			...
			if (Utility.RandomDouble() < .25 ) PackItem( new Sierp() );
		}
